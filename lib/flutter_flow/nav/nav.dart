...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'workOrderListField',
          path: '/workOrderListField',
          builder: (context, params) => params.isEmpty
              ? const NavBarPage(initialPage: 'workOrderListField')
              : const WorkOrderListFieldWidget(),
        ),
        FFRoute(
          name: 'workOrderDetailField',
        ...
        FFRoute(
          ...
          builder: (context, params) => List1Widget(
            ...
            typeStr: params.getParam('typeStr', ParamType.String),
            customerId: params.getParam('customerId', ParamType.int),
        ...
        FFRoute(
          name: 'list2',
          path: '/list2',
          builder: (context, params) => List2Widget(
            type: params.getParam('type', ParamType.String),
            typeStr: params.getParam('typeStr', ParamType.String),
            customerId: params.getParam('customerId', ParamType.int),
            customerName: params.getParam('customerName', ParamType.String),
        ...
        FFRoute(
          name: 'list3',
          path: '/list3',
          builder: (context, params) => List3Widget(
            type: params.getParam('type', ParamType.String),
            typeStr: params.getParam('typeStr', ParamType.String),
            customerId: params.getParam('customerId', ParamType.int),
            customerName: params.getParam('customerName', ParamType.String),
        ...
        FFRoute(
          name: 'list4',
          path: '/list4',
          builder: (context, params) => List4Widget(
            type: params.getParam('type', ParamType.String),
            typeStr: params.getParam('typeStr', ParamType.String),
            customerId: params.getParam('customerId', ParamType.int),
            customerName: params.getParam('customerName', ParamType.String),
